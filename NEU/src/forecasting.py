...
def plot_time_series(before_df, after_df):
    ...
    print("Time Series with Forecast saved successfully.") # Added for debugging
...
def plot_forecast_with_split(df):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('output/Hourly Tip Share with Forecast.png')
    plt.close() # Add this line to close the figure
    print("Hourly Tip Share with Forecast saved successfully.") # Added for debugging